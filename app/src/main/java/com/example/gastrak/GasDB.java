...
public class GasDB extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_TABLE_GASPRICES =
            "CREATE TABLE " + PricesEntry.TABLE_NAME + " ( "
                    + PricesEntry.COLUMN_NAME_GASID + " varchar(100) PRIMARY KEY, "
                    + PricesEntry.COLUMN_NAME_STATIONNAME + " varchar(50) NOT NULL,"
                    + PricesEntry.COLUMN_NAME_STATIONADDRESS + " varchar(50) NOT NULL,"
                    + PricesEntry.COLUMN_NAME_LATITUDE + " varchar(100),"
                    + PricesEntry.COLUMN_NAME_LONGITUDE + " varchar(100),"
                    + PricesEntry.COLUMN_NAME_PHONENUMBER + " varchar(20),"
                    + PricesEntry.COLUMN_NAME_PLUSCODE + " varchar(30),"
                    + PricesEntry.COLUMN_NAME_RATING + " INTEGER,"
                    + PricesEntry.COLUMN_NAME_URI + " varchar(100),"
                    + PricesEntry.COLUMN_NAME_USERRATINGSTOTAL + " INTEGER,"
                    + PricesEntry.COLUMN_NAME_UPLOADEDBY + " varchar(100),"
    ...
    private static final String SQL_CREATE_TABLE_VEHICLES =
            "CREATE TABLE " + VehiclesEntry.TABLE_NAME + " ( "
                    ...
                    + VehiclesEntry.COLUMN_NAME_SETASDEFAULT + " int NOT NULL)";
...
class PricesEntry implements BaseColumns {
    ...
    public static final String COLUMN_NAME_PLUSCODE = "PlusCode";
    public static final String COLUMN_NAME_RATING = "Rating";
    public static final String COLUMN_NAME_URI = "Uri";
    public static final String COLUMN_NAME_USERRATINGSTOTAL = "UserRatingsTotal";
    public static final String COLUMN_NAME_UPLOADEDBY = "UploadedBy";
...
class VehiclesEntry implements BaseColumns {
    ...
    public static final String COLUMN_NAME_SETASDEFAULT = "SetAsDefault";
}
